...
function Combat() {
  ...
  return (
    <div style={{
      ...
      >
        {/* LOG Combate - IZQUIERDA en desktop */}
        {!isMobile && (
          <div
            style={{
              width: '300px',
        ...
        >
          ...
          {!showTeamSelection ? (
            ...
            // ...contenedor de selección de equipo...
            <div style={{
              display: 'flex',
              flexWrap: 'wrap',
              justifyContent: 'center',
      ...
      {/* CONTENEDOR INFERIOR: LOG */}
      {/* Elimina este bloque, ya que el log solo debe mostrarse en un lugar según isMobile */}
      {/* <div
        style={{
          ...
          borderRadius: '10px',
          boxShadow: '0 2px 6px rgba(0,0,0,0.1)',
          maxHeight: isMobile ? '250px' : '600px', // Reducido en móvil
          minHeight: isMobile ? '100px' : '200px', // Reducido en móvil
          overflowY: 'auto',
          fontSize: '14px',
      ...
      <div
        style={{
          ...
          padding: isMobile ? '8px 0 0 0' : '16px 20px',
          zIndex: 100,
        ...
        {isMobile ? (
          <>
            <button
              ...
              onClick={() => setShowTeamMobile((v) => !v)}
            >
              {showTeamMobile ? 'Ocultar equipo ▲' : 'Mostrar equipo ▼'}
            </button>
            {showTeamMobile && (
              <div style={{
                display: "flex",
